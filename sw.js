...
const CACHE_NAME = 'maree-horloge-shell-v4';
...
self.addEventListener('fetch', (event) => {
  ...
  // l'API Cache n'accepte que les requêtes GET (PUT/POST/HEAD la font
  // planter) — pour tout le reste on laisse simplement passer au réseau
